          ...
          <div className="p-6">
            ...
            <div className="flex gap-4">
              ...
              <div className="w-[260px] flex-shrink-0 rounded-lg border border-neutral-200 shadow-sm overflow-hidden">
                <div className="h-[46px] border-b border-neutral-200 flex items-center px-5">
                  <div className="flex items-center gap-2">
                    <span className="inline-flex items-center justify-center w-[21px] h-5 px-1.5 rounded-full bg-primary-50 text-sm font-bold text-[#193CB8] leading-5">1</span>
                    <h2 className="text-base font-bold text-text-primary leading-6">법인/부서 선택</h2>
                  </div>
                </div>
                  ...
                  <div className="relative">
                    <button className="w-full h-8 px-3 flex items-center justify-between rounded border border-neutral-200 shadow-[0_1px_2px_0_rgba(50,56,62,0.08)] bg-white hover:bg-neutral-20">
                      <div className="flex items-center gap-1">
                        <span className="text-sm text-text-tertiary">법인 선택</span>
                        <div className="inline-flex items-center gap-0.5 h-5 px-1.5 rounded-full bg-primary-50">
                          <span className="text-xs text-[#193CB8]">설정 그룹</span>
                ...
                <div className="p-5">
                  ...
                  <div className="space-y-1">
                    {departments.map((dept, idx) => (
                      ...
                      >
                        <span className={`text-sm ${dept.selected ? 'font-bold text-primary' : 'font-normal text-text-primary'}`}>
              ...
              <div className="flex-1 rounded-lg border border-neutral-200 shadow-sm overflow-hidden">
                <div className="h-[46px] border-b border-neutral-200 flex items-center px-5">
                  <div className="flex items-center gap-2">
                    <span className="inline-flex items-center justify-center w-[23px] h-5 px-1.5 rounded-full bg-primary-50 text-sm font-bold text-[#193CB8] leading-5">2</span>
                    <h2 className="text-base font-bold text-text-primary leading-6">에이전트 사용 설정</h2>
                  </div>
                </div>

                <div className="p-5 border-b border-neutral-200">
                  <div className="flex items-center justify-between mb-4">
                    <span className="text-sm font-bold text-text-secondary">선택된 법인/부서</span>
                    <div className="flex items-center gap-1 text-sm">
                      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M13.9993 12.6667H15.3327V14H0.666016V12.6667H1.99935V2.66667C1.99935 2.29848 2.29783 2 2.66602 2H9.33268C9.70088 2 9.99935 2.29848 9.99935 2.66667V12.6667H12.666V7.33333H11.3327V6H13.3327C13.7009 6 13.9993 6.29848 13.9993 6.66667V12.6667ZM3.33268 3.33333V12.6667H8.66602V3.33333H3.33268ZM4.66602 7.33333H7.33268V8.66667H4.66602V7.33333ZM4.66602 4.66667H7.33268V6H4.66602V4.66667Z" fill="#45556C"/>
                      </svg>
                      <span className="text-text-primary px-1">설정 그룹</span>
                      <span className="text-text-secondary">/</span>
                      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M4.66732 3.33366V1.33366C4.66732 0.965472 4.9658 0.666992 5.33398 0.666992H10.6673C11.0355 0.666992 11.334 0.965472 11.334 1.33366V3.33366H14.0007C14.3689 3.33366 14.6673 3.63214 14.6673 4.00033V13.3337C14.6673 13.7019 14.3689 14.0003 14.0007 14.0003H2.00065C1.63246 14.0003 1.33398 13.7019 1.33398 13.3337V4.00033C1.33398 3.63214 1.63246 3.33366 2.00065 3.33366H4.66732ZM2.66732 10.667V12.667H13.334V10.667H2.66732ZM2.66732 9.33366H13.334V4.66699H2.66732V9.33366ZM6.00065 2.00033V3.33366H10.0007V2.00033H6.00065ZM7.33398 7.33366H8.66732V8.66699H7.33398V7.33366Z" fill="#45556C"/>
                      </svg>
                      <span className="text-text-primary px-1">재무 담당자</span>
                    </div>
                  </div>

                  <div className="flex items-center gap-10">
                    <span className="text-sm font-bold text-text-secondary">에이전트 사용 여부</span>
                    <div className="flex items-center gap-1">
                    ...
                    <tbody>
                      {agents.map((agent, idx) => (
                        <tr key={agent.id} className="bg-white">
                          <td className={`h-[46px] px-2 border-b border-l border-neutral-200 ${idx === agents.length - 1 ? 'rounded-bl' : ''}`}>
